...
?>
    <div class="whole">
        <div class="innerbox">
            ...
            <form method="post"name="loginform" action="" required autocomplete="off" class="textfield">
                <div class="text_field">
                   <input type="text" name="usern" class="inputs inputtext"><label class="text">username</label>
                 </div>
                 <p><?php echo '<span style="color:red line-height:10px height:10px;">&nbsp;'.$usernameErr.'</span>' ?></p>
               <div class="text_field">
                   <input type="password" name="passw" class="inputs inputps"><label class="text">password</label>
                </div >
